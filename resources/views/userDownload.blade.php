...
<main id="main">
      <section class="inner-page breadcrumbs team section-bg" id="breadcrumbs">
        <div class="container">
          <div class="row">
            ...
            <div class="col">
              <form id="sform" class="d-flex" action="{{ route('searchDocumentUser') }}" method="post"> 
                @csrf
          ...
          <div class="section-title">
            <h2>Documents</h2>
            <p>See The Research Documents of the Species.</p>
          </div>
          <div class="row">
            @if ($documents->count())
              ...
              <div class="col-lg-6  mt-4 mt-lg-8">
                <div class="member d-flex align-items-start">
                  <div class="member-info text-start text-success">
                    ...
                    <div class="row gap-8">
                        <div class="col-md-4">
                            <a href="{{ url('/view', $document->id) }}">                
                              <i class="btn btn-primary btn-sm">view</i> 
                            </a>                
                        </div> 
                        <div class="col-md-8">
                            <a href="{{ url('/download', $document->file) }}">                
                              <i class="btn btn-success btn-sm">Download</i> 
                            </a>                
                        </div>  
                    </div>                                                      
                </div>         
  ...
  <script src="https://cdn.jsdelivr.net/npm/jquery@3.6.0/dist/jquery.min.js"></script>
    ...
    <script type="text/javascript">
        var route = "{{ url('autocomplete-searchUser') }}";
        $('#search').typeahead({
