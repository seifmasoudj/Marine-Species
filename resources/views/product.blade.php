             ...
             <div class="panel panel-default">
                 <div class="panel-heading">
                     <div class="row">
                         ...
                         <div class="col-md-2">
                             <a href="{{ route('show') }}" class="btn btn-success pull-right">All Documents</a>
                         </div>
                     </div>
                 </div>
            ...
            <form action="{{ url('uploadproduct') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="name" placeholder="Enter FileName" class="form-control input-md @error('name') border border-danger @enderror" value="{{old('name')}}">
                        @error('name')  <p class="text-danger">{{ $message }}</p> @enderror                              
                    </div>
                    <div class="form-group col-md-6">
                        <label class="col-md-4 control-label" for="">Description <span class="text-danger">*</span></label>                              
                        <input type="text" name="description" placeholder="Enter description" class="form-control input-md @error('description') border border-danger @enderror" value="{{old('description')}}">
                        @error('description')  <p class="text-danger">{{ $message }}</p> @enderror                              
                    </div>
                    <div class="form-group col-md-6">
                        <label class="col-md-4 control-label" for="">File <span class="text-danger">*</span></label>                              
                        <input type="file" name="file" class="form-control input-md @error('file') border border-danger @enderror" value="{{old('file')}}">
