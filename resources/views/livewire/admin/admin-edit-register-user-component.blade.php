           ...
           <div class="panel panel-default">
               ...
               <div class="panel-body">
                   ...
                   <form class="form-horizontal" wire:submit.prevent="updateUser">
                       ...
                       <div class="form-group">
                            <label class="col-md-4 control-label" for="">User Role</label>
                            <div class="col-md-4">                          
                                <select class="form-control input-md @error('utype') border border-danger @enderror" value="{{old('utype')}}" name="utype" id="utype" wire:model="utype">
