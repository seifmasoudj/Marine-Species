       ...
       <div class="col-md-12">
           <div class="panel panel-default">
               ...
               <div class="mb-3">
                   ...
                   @endif
                   <form class="form-horizontal" wire:submit.prevent="UpdateSpecies">
                    <div class="row">
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control input-md @error('newimage') border border-danger @enderror" value="{{old('newimage')}}" wire:model="newimage">
                                @if($newimage)
                                    <img src="{{ $newimage->temporaryUrl() }}" width="120" alt="">
                                @else
                                    <img src="{{ asset('assets/img/NewSpecies') }}/{{ $newimage }}"  width="120" alt="">
                                @endif
