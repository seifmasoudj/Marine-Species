...
body {
  ...
  */
      ...
      <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar">
              ...
              <h1 class="logo me-auto"><a href="#"><img src="{{ asset('assets/img/ZanzibarMarine.png') }}"></a></h1>       
                  ...
                  @auth                           
                      <li>
                        <a class="nav-link scrollto" href="{{ ('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a> 
                      </li>
  ...
  <!-- .navbar -->
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="row">
                        ...
                        <div class="col">
                            <a href="{{ route('admin.documentPDF',['download'=>'pdf']) }}" class="btn btn-success">Report</a>
                        </div>
                        <div class="col">
                            <a href="{{ route('uploadpage') }}" class="btn btn-success">Add New</a>
                        </div>
                        <div class="col">
                          <form id="sform" class="d-flex" action="{{ route('searchDocument') }}" method="post"> 
                            @csrf
                                      ...
                                      @foreach ($documents as $document)
                                          <tr>
                                              ...
                                              <td class="text-center">
                                                <a href="{{ url('/view', $document->id) }}">View</a>
                                                <a href="{{ url('/download', $document->file) }}" style="margin-left:20px;">Download</a>
                                                <a href="{{ url('delete/'.$document->id) }}" onclick="confirm('Are you sure, You want to delete this Document?') || event.stopImmediatePropagation()" style="margin-left:20px;"><i class="bi bi-trash3-fill"></i></a>
                                              </td>
                                          </tr>
                                      @endforeach
                                    @else
                                     <div class="alert alert-warning" role="alert">No document Found, try Search again!</div>
                                    @endif
                                </tbody>
                            </table>
                        </div>
    ...
    <a href="#" class="back-to-top d-flex align-items-center justify-content-center"><img src="{{ asset('assets/img/up.png') }}"  style="width: 10px;"></a>
